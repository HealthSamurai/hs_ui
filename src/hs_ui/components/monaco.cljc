            ...
            (.defineTheme (.-editor ^js/Object instance)
                          ...
                          (clj->js {:base    "vs"
                                    ...
                                    :colors  {"editor.background" "#FFFFFF"
                                              ...
                                              "editorSuggestWidget.border"     "#EBECEE"
                                              "editorSuggestWidget.selectedBackground" "#F7F7F8"
                                              "editorSuggestWidget.selectedForeground" "#1D2331"
                                              "editorSuggestWidget.foreground" "#1D2331"
                                              "editorSuggestWidget.highlightForeground" "#1D2331"
                                              "editorSuggestWidget.focusHighlightForeground" "#1D2331"
